...
async function processPhoto(ctx) {
    try {
        ...
        await ctx.createNewStickerSet(stickerSetName, '@Ai_BgRemover_byHunter_Bot', { png_sticker: stickerFile.file_id, emojis: '❤️' })
...
bot.help(ctx => ctx.reply('For Help Contact => @Unknown_31o'))
